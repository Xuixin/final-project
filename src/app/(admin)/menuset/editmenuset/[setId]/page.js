    ...
    const addMenuIntoSet = (e) => {
        ...
        if (menu) {
            ...
            if (existingMenu) {
                ...
                setFormValues({
                    ...formValues,
                    menu: [...formValues.menu, { ...menu, quantity: parseInt(menuForm.quantity) }]
                })
            }
        } else {
            toast({
            ...
            <form onSubmit={handleSubmit} className="mx-auto grid min-w-[80%] flex-1 auto-rows-max gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div className="hidden items-center gap-2 md:ml-auto md:flex">
                        <Button variant="outline" size="sm" onClick={() => router.push('/menuset/allmenuset')}>
                            Discard
                        </Button>
                        <Button size="sm" type="submit">Save Set</Button>
                    </div>
                </div>
                                ...
                                <div className="grid gap-6 grid-cols-3">
                                    ...
                                    <div className="grid gap-3">
                                        ...
                                        <Select onValueChange={(value) => setMenuForm({ ...menuForm, id: value })}>
                                            <SelectTrigger id="discount" aria-label="Select Menu">
                                    ...
                                    <Table>
                                        <TableHeader>
                                            <TableRow>
                                                ...
                                                <TableHead className="text-center">Actions</TableHead> {/* เพิ่มคอลัมน์สำหรับการลบ */}
                                            </TableRow>
                                        </TableHeader>
                                        <TableBody>
