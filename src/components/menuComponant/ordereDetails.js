        ...
        <>
            <DialogContent className='max-w-[425px] lg:max-h-[425px] lg:overflow-auto'>
                ...
                <div className='grid gap-4 py-4 px-5'>
                    {order.normalmenu.length > 0 && order.normalmenu.map((menu) => {
                        return (
                            <div key={menu.id} className='grid grid-cols-4 items-center gap-4'>
                ...
                {order.normalmenu.length > 0 && <DialogDescription>Menuset</DialogDescription>}
                <div className='grid gap-4 py-4'>
                    {order.setmenu.length > 0 && order.setmenu.map((set) => {
                        return (
                            <div key={set.setId} className='grid grid-cols-4 items-start gap-4'>
                                ...
                                <div className='col-span-3'>
                                    {set.details.map((menu) => {
                                        return (
                                            <div key={menu.id} className='grid gap-2 grid-cols-2'>
